    ...
    <>
      {pins.map((pin, index) => (
        <input
          ...
          type="text"
          id={`pin-${index}`}
          className={classNames('text-center border border-gray-300 rounded cursor-pointer focus:outline-none focus:ring-2 dark:border-[#2E2E2E] dark:bg-[#1C1C1B]', className, sizeClass)}
          maxLength="1"
          value={pin}
